export const COUNTRY_CODES = [
  // India first (NRI / resident)
  { code: '+91', label: '🇮🇳 IN', country: 'India' },

  // Top countries with large NRI/Indian diaspora
  ...
  // Other countries with significant NRI populations
  ...
  { code: '+886', label: '🇹🇼 TW', country: 'Taiwan' },
  { code: '+44', label: '🇮🇪 IE', country: 'Ireland' },
  ...
  { code: '+420', label: '🇨🇿 CZ', country: 'Czech Republic' },
]
