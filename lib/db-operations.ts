        ...
        if (loanRow) {
          return {
            ...
            data: {
              ...
              statusColor: loanRow.status_color || '#FF9933',
              ...
              allowWithdrawal: loanRow.status_color === '#138808',
              currency: 'INR',
            },
          };
        }
    ...
    if (!loanError && loanData) {
      return {
        ...
        data: {
          ...
          statusColor: loanData.status_color || '#FF9933',
          ...
          allowWithdrawal: loanData.status_color === '#138808',
          currency: 'INR',
        },
      };
    }
