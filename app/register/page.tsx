        ...
        <div className="w-full max-w-md">
          ...
          <div className="bg-[var(--color-bg-surface)] rounded-2xl shadow-[0_4px_20px_rgba(0,0,0,0.08)] p-6 border border-[var(--color-border)]">
            <form onSubmit={handleSubmit} className="space-y-5">
              {/* Error Message */}
              {error && (
                <div className="p-4 bg-[var(--color-primary-100)] border border-[var(--color-border)] rounded-xl flex items-start gap-3">
              ...
              {/* Terms Agreement */}
              <div className="flex items-start gap-3 bg-[var(--color-bg-main)] p-4 rounded-xl">
                <input
                  type="checkbox"
                  id="terms"
                  className="mt-1 w-4 h-4 text-[var(--color-accent-500)] border-gray-300 rounded focus:ring-[var(--color-primary-700)]"
                  required
                />
                <label htmlFor="terms" className="text-xs text-[var(--color-text-secondary)]">
                  I agree to the{' '}
                  <Link href="/terms" className="text-[var(--color-accent-500)] hover:underline font-medium">
                    Terms of Service
                  </Link>{' '}
                  and{' '}
                  <Link href="/privacy" className="text-[var(--color-accent-500)] hover:underline font-medium">
                    Privacy Policy
                  </Link>
                  .
                </label>
