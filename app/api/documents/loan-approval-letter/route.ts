...
async function generateExcel(documentNumber: string, loanData: any) {
  ...
  // Company Information - EasyLoan India
  const companyName = "EASY LOAN COMPANY PVT LTD"
  const rbiRegistrationNo = "N-13.02218"
  const dateRegistered = "15-March-1986"
  const officeLocation = "Maker Maxity, Bandra Kurla Complex, Mumbai - 400051, Maharashtra, India"
  const contactEmail = "support@easyloancompany.com"
  const contactPhone = "+91 22 6789 1234"
  
  // Format effective date
  const effectiveDate = loanData.effectiveDate || new Date().toLocaleDateString('en-IN', { 
    year: 'numeric', 
    month: 'short', 
    day: '2-digit' 
  }).replace(/,/g, '')
  ...
  const mainData = [
    ...
    ['TERM AND CONDITIONS', '', '', '', '', '', '', ''],
    [`On the behalf of ${companyName}, We're pleased to congratulate valued customer regarding your loan application has been approved on the terms set forth below, subject to the conditions set forth in the Conditions, Addendum to this Loan Approval, and further subject to any other conditions, EasyLoan may establish upon receipt and review of documentation in satisfaction of the Initial Conditions (the "Subsequent Conditions"). For details of the monthly payment, the Loan Assistance Staff will provide details in a separate letter. Thank you.`, '', '', '', '', '', '', ''],
    ['', '', '', '', '', '', '', ''],
    ...
    [`Interest Rate ${loanData.interestRate || '0%'}: ${loanData.interestAmount || '₹0.00 / Month (EMI)'}`, '', '', '', '', '', '', ''],
    ...
    ['RBI: Reserve Bank of India (NBFC)', '', '', 'Signature:', 'Applied', '', '', ''],
    ['MCA: Ministry of Corporate Affairs', '', '', 'Signature Stamp:', 'Applied', '', '', ''],
    ['CIBIL: Credit Bureau', '', '', 'FINANCIAL DEPARTMENT', '', '', '', ''],
    ['', '', '', companyName, '', '', '', ''],
    ['', '', '', '', '', '', '', ''],
    ...
    ['Empowering NRIs with fast, accessible, and secure financial solutions worldwide.', '', '', '', '', '', '', '']
  ]
  ...
  return new NextResponse(excelBuffer, {
    headers: {
      ...
      'Content-Disposition': `attachment; filename="EasyLoan-Loan-Approval-${documentNumber}.xlsx"`
    }
  })
}
...
function generateHTML(documentNumber: string, loanData: any, format: string) {
  ...
  const contactEmail = "support@easyloancompany.com"
  const contactPhone = "+91 22 6789 1234"
  const loanOfficerPhone = "+91 22 6789 1234"
  ...
  const idCardHtml = loanData.idCardImage 
    ? `<div style="position: relative; width: 100%; height: 100%; display: flex; align-items: center; justify-content: center;">
         <img src="${loanData.idCardImage}" alt="ID Card/Passport" style="max-width: 100%; max-height: 100%; object-fit: contain;" />
         <div style="position: absolute; bottom: 15px; right: 15px; width: 96px; height: 96px;">
           <img src="/logos/approved-stamp.png" alt="Loan Approved Stamp" style="width: 100%; height: 100%; object-fit: contain; opacity: 0.9; filter: drop-shadow(0 4px 6px rgba(0,0,0,0.1));" />
         </div>
       </div>`
    ...
    <body>
      ...
      <div class="header">
        <div class="company-logo">
          <img src="/logos/EasyLoan.png" alt="EasyLoan Logo" />
          <div class="company-name">
            <h1>${companyName}</h1>
            <p class="company-tagline">Empowering NRIs with fast, accessible, and secure financial solutions worldwide.</p>
          </div>
        </div>
        ...
        <div class="header-logos">
          <!-- RBI Logo -->
          <div class="logo-item">
            <img src="/logos/rbi.png" alt="RBI Logo" />
            <span class="logo-text">Reserve Bank</span>
            <span class="logo-text">of India</span>
          </div>
          
          <!-- MCA Logo -->
          <div class="logo-item">
            <img src="/logos/mca.png" alt="MCA Logo" />
            <span class="logo-text">Ministry of</span>
            <span class="logo-text">Corporate Affairs</span>
          </div>
          
          <!-- CIBIL Logo -->
          <div class="logo-item">
            <img src="/logos/cibil.png" alt="CIBIL Logo" />
            <span class="logo-text">CIBIL</span>
          </div>
        </div>
      </div>
      ...
      <div class="between-section">
        ...
        <div class="lender-column">
          ...
          <div class="info-row">
            <div class="info-label">RBI REGISTRATION NO:</div>
            <div class="info-value">${rbiRegistrationNo}</div>
          </div>
          <div class="info-row">
            <div class="info-label">DATE REGISTERED (RBI):</div>
        ...
        <div class="loan-details">
          ...
          <div>
            ...
            <div class="loan-detail-row">
              ...
              <span class="loan-detail-value">${loanData.interestAmount || '₹0.00 / Month (EMI)'}</span>
            </div>
            <div class="loan-detail-row">
            ...
            <div class="loan-detail-row">
              ...
              <span class="loan-detail-value">${loanData.installmentDate || '5th of every month'}</span>
            </div>
            <div class="loan-detail-row">
              <span class="loan-detail-label">Monthly EMI :</span>
      ...
      <div class="signature-section">
        ...
        <div class="dept-logos">
          ...
          <div class="dept-logo-item">
            <img src="/logos/rbi.png" alt="RBI Logo" />
            <span class="dept-logo-text">Reserve Bank</span>
            <span class="dept-logo-text">of India</span>
          </div>
          
          <!-- MCA Logo -->
          <div class="dept-logo-item">
            <img src="/logos/mca.png" alt="MCA Logo" />
            <span class="dept-logo-text">Ministry of</span>
            <span class="dept-logo-text">Corporate Affairs</span>
          </div>
          
          <!-- CIBIL Logo -->
          <div class="dept-logo-item">
            <img src="/logos/cibil.png" alt="CIBIL Logo" />
            <span class="dept-logo-text">CIBIL</span>
          </div>
        </div>
          ...
          <div class="signature-wrapper">
            ...
            <div class="stamp-wrapper">
              ...
              <div class="signature-stamp">
                <img src="/logos/company-stamp.png" alt="Signature Stamp" />
              </div>
            </div>
  ...
  return new NextResponse(html, {
    headers: {
      ...
      'Content-Disposition': `attachment; filename="EasyLoan-Loan-Approval-${documentNumber}.html"`
    }
  })
}
