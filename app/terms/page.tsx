      ...
      <main className="max-w-4xl mx-auto px-4 py-8">
        ...
        <div className="bg-gradient-to-r from-[#FF9933] to-[#138808] text-white rounded-2xl p-8 mb-8">
          ...
          <div className="flex items-center gap-4 mt-4">
            ...
            <span className="text-sm text-white/80 ml-2">Government Regulated NBFC</span>
          </div>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-3 gap-6 mb-8">
          <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all">
            ...
            <p className="text-gray-600 text-sm">Binding contract between you and EasyLoan under Indian law</p>
          </div>
          
          <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all">
            <div className="flex items-center gap-3 mb-4">
              <Gavel className="w-6 h-6 text-[#138808]" />
              <h3 className="font-bold text-lg">Indian Law</h3>
            </div>
            <p className="text-gray-600 text-sm">Governed by laws of India and RBI regulations</p>
          </div>
          ...
          <div className="bg-white rounded-xl p-6 shadow-lg hover:shadow-xl transition-all">
            ...
            <p className="text-gray-600 text-sm">Use of services equals acceptance under IT Act 2000</p>
          </div>
        </div>
                ...
                <div className="mt-6 pt-4 border-t border-gray-200">
                  ...
                  <div className="space-y-2">
                    <div className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-[#138808]" />
                      <span className="text-xs text-gray-600">RBI Registration No. {COMPANY_INFO.rbiRegistrationNo}</span>
                    </div>
                    <div className="flex items-center gap-2">
                      <CheckCircle className="w-4 h-4 text-[#138808]" />
                    ...
                    <tbody>
                      {loanTerms.map((term, index) => (
                        <tr key={index} className={index % 2 === 0 ? 'bg-gray-50' : 'bg-white'}>
                          ...
                          <td className="p-4 text-[#138808] font-semibold">{term.rate}</td>
                        </tr>
                      ))}
                    </tbody>
                  </table>
