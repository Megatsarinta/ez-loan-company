    ...
    <div className="mb-8">
      ...
      <div 
        className={`
          ...
          ${!preview && !url ? 'cursor-pointer hover:border-[#FF9933] hover:shadow-lg' : ''}
          ${isActive ? 'ring-2 ring-[#FF9933] ring-offset-2' : ''}
        `}
            ...
            <div className="absolute inset-0 bg-black/0 hover:bg-black/5 transition-colors flex items-center justify-center">
              <div className="opacity-0 hover:opacity-100 transition-opacity">
                <div className="bg-white/90 backdrop-blur-sm rounded-full px-5 py-2.5 shadow-lg">
                  <span className="text-sm font-semibold text-[#FF9933]">Click to upload</span>
                </div>
              </div>
            </div>
          </div>
      ...
      <Button
        ...
        className={`
          ...
          ${uploading || url 
            ...
            : 'bg-gradient-to-r from-[#FF9933] to-[#138808] hover:from-[#e68a2e] hover:to-[#0f6d07] text-white shadow-lg hover:shadow-xl'
          }
        `}
      >
        {uploading ? (
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f5f7fa] to-[#e9ecef] pb-8">
      ...
      <main className="px-4 py-6 max-w-2xl mx-auto">
        ...
        <div className="mb-8">
          ...
          <p className="text-[#6C757D]">Take clear photos of your KYC identification (Aadhaar/PAN)</p>
        </div>
        ...
        <Button
          ...
          className={`
            w-full bg-gradient-to-r from-[#FF9933] to-[#138808] hover:from-[#e68a2e] hover:to-[#0f6d07]
