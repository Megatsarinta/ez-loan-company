...
export default function LoanListTablePage() {
  ...
  // Mock loans data (Indian names, status "Loan Approved", green #138808, terms 6/12/24/36 only)
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-md p-6 h-fit sticky top-24">
          ...
          <div className="mb-6">
            ...
            <div className="flex items-center gap-2 border-2 border-gray-200 rounded-lg px-3 py-2 focus-within:ring-2 focus-within:ring-[#FF9933] transition-shadow bg-white mb-3">
            ...
            <Button
              ...
              className="w-full bg-gradient-to-r from-[#FF9933] to-[#138808] text-white font-semibold py-2 rounded-lg hover:shadow-lg hover:-translate-y-0.5 transition-all"
            >
          ...
          <div className="mb-6">
            ...
            <input
              ...
              className="w-full px-3 py-2 border-2 border-gray-200 rounded-lg focus:outline-none focus:ring-2 focus:ring-[#FF9933] focus:border-transparent text-sm"
            />
          ...
          {/* Results Summary */}
          <div className="mb-6 p-4 bg-gradient-to-r from-blue-50 to-red-50 rounded-lg border border-[#FF9933]/20">
            <p className="text-sm font-medium text-[#212529] flex items-center gap-1">
              <CheckCircle className="w-4 h-4 text-[#00A86B]" />
              Showing <span className="font-bold text-[#FF9933]">{filteredLoans.length}</span> loans
            </p>
            {realUser && (
