...
export default function LoanApprovalLetterPage() {
  ...
  const fetchCompleteLoanData = async (loanId: string, documentNumber: string) => {
    try {
      ...
      const interestRateDecimal = Number(loan.interest_rate) || 0; // 0.005, 0.006, etc.
      ...
      const interestPerMonth = loanAmount * interestRateDecimal;
      const monthlyInstallment = monthlyPrincipal + interestPerMonth;
      const totalRepayment = monthlyInstallment * loanPeriodMonths;
      ...
      setCurrentLoanData({
        ...
        loanAmount: `₹${loanAmount.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
        interestRate: `${(interestRateDecimal * 100).toFixed(2)}% per month`,
        interestAmount: `₹${interestPerMonth.toFixed(2)} / Month (EMI)`,
        loanTerm: `${loanPeriodMonths} months`,
        installmentDate: nextInstallmentDate,
        monthlyInstallment: `₹${monthlyInstallment.toFixed(2)}`,
        totalRepayment: `₹${totalRepayment.toLocaleString('en-IN', { minimumFractionDigits: 2, maximumFractionDigits: 2 })}`,
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f5f7fa] to-[#e9ecef] p-6 md:p-10">
      ...
      <div className="mb-8">
        ...
        <div className="flex items-center justify-between">
          ...
          {/* Government Badge */}
          <div className="hidden md:flex items-center gap-2 bg-gradient-to-r from-orange-50 to-green-50 px-3 py-1.5 rounded-full border border-[#FF9933]/20">
      ...
      <div className="grid grid-cols-1 lg:grid-cols-3 gap-8">
          ...
          <div className="bg-white rounded-2xl border border-gray-200 shadow-md p-6 overflow-auto max-h-[800px]">
            {isLoading ? (
              <div className="flex flex-col items-center justify-center h-96 text-gray-500">
                <Loader className="w-8 h-8 animate-spin text-[#FF9933] mb-4" />
        ...
        <div className="bg-white rounded-2xl border border-gray-200 shadow-md p-6 h-fit sticky top-24">
              ...
              {currentLoanData && !showNotFound && (
                <div className="mt-2 p-3 bg-green-50 border border-green-200 rounded-lg">
                  <div className="flex items-start justify-between gap-2">
                    ...
                    <button
                      onClick={clearSearch}
                      className="text-[#138808] hover:text-[#008f5a] text-xs font-medium"
                    >
                      Clear
                    </button>
                  </div>
              ...
              <div>
                ...
                <div className="relative">
                  ...
                  <label
                    ...
                    className="flex items-center justify-center gap-2 p-3 border-2 border-dashed border-gray-300 rounded-lg cursor-pointer hover:border-[#FF9933] transition-colors bg-white"
                  >
          ...
          <Button
            ...
            className="w-full bg-gradient-to-r from-[#FF9933] to-[#138808] text-white font-semibold py-3 rounded-lg hover:shadow-lg hover:-translate-y-0.5 transition-all disabled:opacity-50 disabled:cursor-not-allowed"
          >
            {isLoading ? (
              <>
      ...
      <div className="mt-8 bg-gradient-to-r from-orange-50 to-green-50 rounded-xl p-4 border border-[#FF9933]/20">
