...
export default function AdminDashboardPage() {
  ...
  const metricCard = (
    ...
    <Link href={href} className="block group">
      <Card className="p-6 hover:shadow-xl hover:-translate-y-1 transition-all cursor-pointer h-full border border-gray-100 bg-white group-hover:border-[#FF9933]/30">
      ...
      <main className="px-6 py-8">
        {error && (
          <div className="bg-red-50 border border-red-200 rounded-lg p-4 mb-6 flex items-start gap-3">
            <XCircle className="w-5 h-5 text-[#138808] flex-shrink-0 mt-0.5" />
            <p className="text-sm text-[#138808] font-medium">{error}</p>
          </div>
        )}
          ...
          <div className="flex flex-col md:flex-row gap-4 items-end">
            <div className="flex-1">
              ...
              <input
                ...
                className="w-full px-4 py-2 border border-gray-200 rounded-lg bg-white text-[#212529] focus:outline-none focus:ring-2 focus:ring-[#FF9933] focus:border-transparent"
              />
            </div>
            <div className="flex-1">
            ...
            <Button
              ...
              className="bg-gradient-to-r from-[#FF9933] to-[#138808] hover:from-[#e68a2e] hover:to-[#0f6d07] text-white px-8 py-2 rounded-lg gap-2"
            >
              {isFetchingMetrics ? (
                <>
        ...
        {metrics && (
          <>
            ...
            {/* Quick Actions */}
            <div className="bg-gradient-to-r from-blue-50 to-red-50 rounded-xl p-6 border border-[#FF9933]/20">
              <div className="flex items-center gap-2 mb-4">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-4 gap-3">
                <Link href="/admin/users">
                  <Button variant="outline" className="w-full border-2 border-[#FF9933] text-[#FF9933] hover:bg-[#f0f7ff]">
                    Manage Users
                  </Button>
                </Link>
                <Link href="/admin/loans">
                  <Button variant="outline" className="w-full border-2 border-[#138808] text-[#138808] hover:bg-[#fff0f0]">
                    View Loans
                  </Button>
                </Link>
