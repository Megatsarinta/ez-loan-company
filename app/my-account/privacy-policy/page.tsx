          ...
          <div className="flex items-center gap-4">
            ...
            <div className="flex items-center gap-3">
              ...
              <div>
                ...
                <p className="text-xs text-gray-500">Privacy Policy • IT Act 2000 Compliant</p>
              </div>
            </div>
          </div>
          ...
          <div className="hidden sm:flex items-center gap-3">
            <div className="flex items-center gap-2 bg-orange-50 px-3 py-1.5 rounded-full">
              <Image
                ...
                className="object-contain"
              />
              <span className="font-semibold text-xs text-[#FF9933]">RBI Regd</span>
            </div>
            <div className="flex items-center gap-2 bg-green-50 px-3 py-1.5 rounded-full">
              <Image
                ...
                className="object-contain"
              />
              <span className="font-semibold text-xs text-[#138808]">MeitY Certified</span>
            </div>
        ...
        <div className="flex flex-col md:flex-row md:items-center md:justify-between gap-4">
          <div>
            ...
            <div className="flex items-center gap-4">
              ...
              <span className="px-3 py-1 bg-white/20 rounded-full text-sm">Version 4.0</span>
            </div>
          </div>
        ...
        <div className="grid grid-cols-1 sm:grid-cols-3 gap-4 mt-6">
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 flex items-center gap-3 border border-white/20">
            ...
            <div>
              ...
              <div className="text-sm text-white/80">Data Protection Standards</div>
            </div>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 flex items-center gap-3 border border-white/20">
            ...
            <div>
              ...
              <div className="text-sm text-white/80">Consumer Protection</div>
            </div>
          </div>
          <div className="bg-white/10 backdrop-blur-sm rounded-xl p-4 flex items-center gap-3 border border-white/20">
              ...
              <section className="mt-12 pt-10 border-t border-gray-200">
                <div className="bg-gradient-to-r from-orange-50 to-green-50 rounded-xl p-6 border border-[#FF9933]/20">
                  ...
                  <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
                    <div>
                      <h4 className="font-semibold text-[#212529] mb-3">Grievance Redressal Officer</h4>
                      <div className="space-y-3">
                        <div className="flex items-center gap-3">
                      ...
                      <p className="text-xs text-gray-500 mt-2">For data privacy concerns and complaints</p>
                    </div>
                    ...
                    <div>
                      <div className="space-y-3">
                        <div className="flex items-start gap-3">
                          ...
                          <span className="text-[#6C757D]">Response within 48 hours as per RBI guidelines</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <Users className="w-4 h-4 text-[#138808] mt-1" />
                          <span className="text-[#6C757D]">NRI priority support available</span>
                        </div>
                        <div className="flex items-start gap-3">
                          <Scale className="w-4 h-4 text-[#000080] mt-1" />
                          <span className="text-[#6C757D]">Escalate to RBI Banking Ombudsman if unsatisfied</span>
                        </div>
                      </div>
                    </div>
                  </div>
        ...
        <div className="bg-gradient-to-r from-orange-50 to-green-50 rounded-2xl p-4 border border-[#FF9933]/20">
          <div className="flex flex-wrap items-center justify-center gap-6">
            ...
            <div className="flex items-center gap-2">
              ...
              <span className="text-xs font-medium text-[#138808]">MeitY Certified</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 relative">
                <Image src={GOVERNMENT_LOGOS.digilocker} alt="DigiLocker" width={24} height={24} className="object-contain" />
              </div>
              <span className="text-xs font-medium text-[#000080]">DigiLocker</span>
            </div>
            <div className="flex items-center gap-2">
              <div className="w-6 h-6 relative">
                <Image src={GOVERNMENT_LOGOS.cibil} alt="CIBIL" width={24} height={24} className="object-contain" />
              </div>
              <span className="text-xs font-medium text-[#FF9933]">CIBIL Partner</span>
            </div>
          </div>
        </div>
      </div>
