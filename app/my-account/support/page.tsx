  ...
  return (
    <div className="min-h-screen bg-gradient-to-b from-[#f5f7fa] to-[#e9ecef] pb-24">
        ...
        <div className="max-w-6xl mx-auto flex items-center justify-between">
          <div className="flex items-center gap-4">
            <Link href="/my-account" className="mr-2">
              <ArrowLeft className="w-6 h-6 text-[#FF9933] hover:text-[#e68a2e] transition-colors" />
            </Link>
      ...
      <main className="px-4 py-6 max-w-4xl mx-auto">
        ...
        <div className="bg-gradient-to-r from-[#FF9933] to-[#138808] text-white rounded-3xl p-8 shadow-2xl mb-6 relative overflow-hidden">
          {/* Decorative elements */}
          ...
          <div className="relative z-10 text-center">
            <div className="flex items-center justify-center gap-2 mb-4">
              ...
              <span className="text-sm bg-white/20 px-3 py-1 rounded-full">24/7 Customer Support</span>
            </div>
        ...
        <div className="bg-gradient-to-r from-orange-50 to-green-50 rounded-2xl p-4 mb-6 border border-[#FF9933]/20">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-4 mb-6">
          <div className="bg-gradient-to-br from-orange-50 to-white rounded-xl p-6 border border-orange-200">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-[#FF9933] rounded-xl flex items-center justify-center">
                <Phone className="w-6 h-6 text-white" />
              </div>
              <div>
                <h3 className="font-bold text-[#212529]">Phone Support</h3>
                <p className="text-xs text-[#6C757D]">24/7 Helpline</p>
              </div>
            </div>
            <p className="text-lg font-bold text-[#FF9933] mb-2">{COMPANY_INFO.contact.phone}</p>
            <p className="text-sm text-[#6C757D]">Toll-free: {COMPANY_INFO.contact.tollFree}</p>
          </div>

          <div className="bg-gradient-to-br from-green-50 to-white rounded-xl p-6 border border-green-200">
            <div className="flex items-center gap-3 mb-4">
              <div className="w-12 h-12 bg-[#138808] rounded-xl flex items-center justify-center">
            ...
            <p className="text-lg font-bold text-[#138808] mb-2">{COMPANY_INFO.contact.email}</p>
            <p className="text-sm text-[#6C757D]">NRI Support: {COMPANY_INFO.contact.nriEmail}</p>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl p-6 shadow-lg border border-gray-100 mb-6">
          <h2 className="text-xl font-bold text-[#212529] mb-6 flex items-center gap-2">
            <div className="w-8 h-8 bg-gradient-to-r from-[#FF9933] to-[#138808] rounded-lg flex items-center justify-center">
              <MailQuestion className="w-4 h-4 text-white" />
            </div>
            Send Us a Message
          </h2>
          ...
          {formSubmitted ? (
            <div className="bg-green-50 border border-green-200 rounded-xl p-6 text-center">
              <CheckCircle className="w-12 h-12 text-[#138808] mx-auto mb-4" />
              <h3 className="font-bold text-[#212529] mb-2">Message Sent Successfully!</h3>
              <p className="text-sm text-[#6C757D] mb-4">Our support team will get back to you within 2 hours.</p>
              <Button 
                onClick={() => setFormSubmitted(false)}
                className="bg-gradient-to-r from-[#FF9933] to-[#138808] text-white"
              >
            ...
            <form onSubmit={handleContactSubmit} className="space-y-4">
              <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
                <div>
                  ...
                  <Input
                    ...
                    required
                    className="w-full px-4 py-3 border border-gray-300 rounded-xl focus:ring-2 focus:ring-[#FF9933] focus:border-transparent"
                  />
                </div>
                <div>
              ...
              <div>
                <label className="block text-sm font-medium text-[#212529] mb-2">Your Message</label>
                <Textarea
              ...
              <Button
                type="submit"
                className="w-full bg-gradient-to-r from-[#FF9933] to-[#138808] text-white font-semibold py-4 rounded-xl shadow-lg hover:shadow-xl transition-all duration-300"
              >
          ...
          <div className="space-y-3">
            {faqItems.map((item, index) => (
              <div key={index} className="border border-gray-200 rounded-xl overflow-hidden">
                ...
                >
                  <span className="font-medium text-[#212529]">{item.question}</span>
                  {expandedFaq === index ? (
                ...
                {expandedFaq === index && (
                  <div className="px-6 pb-4 text-sm text-[#6C757D] bg-gray-50/50">
                    {item.answer}
                  </div>
                )}
              </div>
        ...
        <div className="bg-gradient-to-r from-blue-50 to-orange-50 rounded-2xl p-6 border border-[#FF9933]/20 mb-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 bg-gradient-to-r from-[#FF9933] to-[#138808] rounded-xl flex items-center justify-center">
              <Shield className="w-6 h-6 text-white" />
            </div>
            <div>
              <h3 className="font-bold text-[#212529]">Grievance Redressal Officer</h3>
              <p className="text-sm text-[#6C757D]">As per RBI guidelines</p>
            </div>
          </div>
          
          <div className="grid grid-cols-1 md:grid-cols-2 gap-4">
            <div className="bg-white/80 p-4 rounded-lg">
              <p className="text-sm font-medium text-[#212529] mb-1">{COMPANY_INFO.keyPersonnel.grievanceOfficer.name}</p>
              <p className="text-xs text-[#6C757D] mb-2">{COMPANY_INFO.keyPersonnel.grievanceOfficer.designation}</p>
              <div className="space-y-1">
                <p className="text-xs flex items-center gap-2">
                  <Mail className="w-3 h-3 text-[#FF9933]" />
                  <a href={`mailto:${COMPANY_INFO.keyPersonnel.grievanceOfficer.email}`} className="text-[#FF9933] hover:underline">
            ...
            <div className="bg-white/80 p-4 rounded-lg">
              <p className="text-sm font-medium text-[#212529] mb-2">Escalation Matrix</p>
              <ul className="text-xs space-y-2 text-[#6C757D]">
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 bg-[#FF9933] rounded-full mt-1.5"></span>
                  <span>If not satisfied with response, escalate to Nodal Officer within 30 days</span>
                </li>
                <li className="flex items-start gap-2">
                  <span className="w-1.5 h-1.5 bg-[#138808] rounded-full mt-1.5"></span>
        ...
        {/* Support Hours */}
        <div className="bg-gradient-to-r from-orange-50 to-green-50 rounded-2xl p-6 border border-[#FF9933]/20 mb-6">
          <div className="flex items-center gap-3 mb-4">
            <div className="w-12 h-12 bg-gradient-to-r from-[#FF9933] to-[#138808] rounded-xl flex items-center justify-center">
            ...
            <div>
              ...
              <p className="text-sm text-[#6C757D]">We're here when you need us</p>
            </div>
          </div>
          <div className="grid grid-cols-1 md:grid-cols-3 gap-4">
            <div className="bg-white/80 p-3 rounded-lg text-center">
              <Phone className="w-5 h-5 text-[#FF9933] mx-auto mb-2" />
              <p className="font-semibold text-[#212529]">Phone Support</p>
              <p className="text-xs text-[#6C757D]">24/7 • Always Open</p>
            </div>
            <div className="bg-white/80 p-3 rounded-lg text-center">
              <Mail className="w-5 h-5 text-[#138808] mx-auto mb-2" />
              <p className="font-semibold text-[#212529]">Email Support</p>
              <p className="text-xs text-[#6C757D]">Response within 2 hrs</p>
            </div>
            <div className="bg-white/80 p-3 rounded-lg text-center">
              <MessageCircle className="w-5 h-5 text-[#000080] mx-auto mb-2" />
              <p className="font-semibold text-[#212529]">Live Chat</p>
              <p className="text-xs text-[#6C757D]">24/7 • Instant</p>
            </div>
          </div>
        </div>
        ...
        <Link href="/my-account" className="block mt-6">
          <Button className="w-full bg-gradient-to-r from-[#FF9933] to-[#138808] hover:from-[#e68a2e] hover:to-[#0f6d07] text-white py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300">
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white shadow-[0_-2px_10px_rgba(0,0,0,0.05)] py-4 z-40 border-t border-gray-100">
        <div className="max-w-2xl mx-auto flex justify-around">
          <Link href="/home" className="flex flex-col items-center px-6 md:px-8 py-2 rounded-lg transition-all text-[#6C757D] hover:text-[#FF9933] hover:bg-orange-50 no-underline">
            <Home className="w-6 h-6 mb-1" />
            <span className="text-xs font-semibold">HOME</span>
          </Link>
          
          <Link href="/wallet" className="flex flex-col items-center px-6 md:px-8 py-2 rounded-lg transition-all text-[#6C757D] hover:text-[#FF9933] hover:bg-orange-50 no-underline">
            <Wallet className="w-6 h-6 mb-1" />
            <span className="text-xs font-semibold">WALLET</span>
          </Link>
          
          <Link href="/my-account" className="flex flex-col items-center px-6 md:px-8 py-2 rounded-lg transition-all text-[#FF9933] bg-orange-50 no-underline">
