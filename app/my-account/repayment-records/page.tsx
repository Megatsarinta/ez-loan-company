...
export default function RepaymentRecordsPage() {
  ...
  const getStatusColor = (status: string) => {
    switch (status) {
      ...
      case 'failed': return '#CE1126' // Red for failed
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#f5f7fa] to-[#e9ecef] flex items-center justify-center">
        <div className="text-center">
          ...
          <p className="text-[#138808] mb-4">{error}</p>
          <Button
            onClick={() => router.back()}
    ...
    return (
      <div className="min-h-screen bg-gradient-to-b from-[#f5f7fa] to-[#e9ecef]">
        ...
        <header className="bg-white shadow-[0_4px_12px_rgba(0,0,0,0.08)] sticky top-0 z-50 px-4 py-4">
          <div className="max-w-6xl mx-auto flex items-center justify-between">
            <div className="flex items-center gap-4">
              <button
                onClick={() => router.back()}
                className="text-[#FF9933] hover:text-[#e68a2e] hover:bg-orange-50/50 p-2 rounded-xl transition-all"
              >
        ...
        <main className="px-4 py-12 max-w-2xl mx-auto flex flex-col items-center justify-center min-h-[60vh]">
          <div className="text-center">
            <div className="bg-gradient-to-r from-blue-50 to-red-50 w-20 h-20 rounded-full flex items-center justify-center mx-auto mb-4 border border-[#FF9933]/20">
              <FileText className="w-10 h-10 text-[#FF9933]" />
            </div>
            ...
            <Button
              onClick={() => router.back()}
              variant="outline"
              className="border-2 border-[#FF9933] text-[#FF9933] hover:bg-orange-50/50"
            >
              Go Back
            </Button>
          </div>
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f5f7fa] to-[#e9ecef] pb-24">
      ...
      <main className="px-4 py-6 max-w-2xl mx-auto">
        ...
        <div className="grid grid-cols-2 gap-4 mb-6">
          <div className="bg-gradient-to-br from-blue-50 to-white rounded-xl border border-[#FF9933]/20 p-4 shadow-sm">
            <div className="flex items-center gap-2 mb-1">
              <TrendingUp className="w-4 h-4 text-[#FF9933]" />
              <p className="text-xs text-[#6C757D]">Total Paid</p>
            </div>
            <p className="text-xl font-bold text-[#FF9933]">{formatINR(summary.totalPaid)}</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-red-50 to-white rounded-xl border border-[#138808]/20 p-4 shadow-sm">
            <div className="flex items-center gap-2 mb-1">
              <Clock className="w-4 h-4 text-[#138808]" />
              <p className="text-xs text-[#6C757D]">Late Payments</p>
            </div>
            <p className="text-xl font-bold text-[#138808]">{summary.latePayments}</p>
          </div>
          ...
          <div className="bg-gradient-to-br from-orange-50 to-white rounded-xl border border-[#FF6B00]/20 p-4 shadow-sm">
            ...
            <p className="text-xl font-bold text-[#FF6B00]">{formatINR(summary.remainingBalance)}</p>
          </div>
        </div>
        ...
        <div className="flex gap-2 mb-6">
          <Button
            ...
            className="flex-1 border-2 border-[#FF9933] text-[#FF9933] hover:bg-orange-50/50 bg-transparent rounded-xl py-3 flex items-center justify-center gap-2"
          >
          ...
          <Button
            ...
            className="flex-1 border-2 border-[#138808] text-[#138808] hover:bg-[#fff0f0] bg-transparent rounded-xl py-3 flex items-center justify-center gap-2"
          >
            <Download className="w-4 h-4" />
            PDF
          </Button>
        ...
        <div className="bg-white rounded-xl shadow-lg border border-gray-100 overflow-hidden mb-6">
          <div className="bg-gradient-to-r from-[#FF9933] to-[#138808] px-4 py-3">
                ...
                <div key={record.id}>
                  ...
                  >
                    ...
                    <div className="text-right mr-3">
                      <p className="text-sm font-bold text-[#212529]">{formatINR(record.amount)}</p>
                      <span
        ...
        <div className="bg-gradient-to-r from-blue-50 to-red-50 rounded-xl p-4 mb-6 border border-[#FF9933]/20">
        ...
        <Button
          onClick={() => router.back()}
          className="w-full bg-gradient-to-r from-[#FF9933] to-[#138808] hover:from-[#e68a2e] hover:to-[#0f6d07] text-white py-4 rounded-xl font-semibold shadow-lg hover:shadow-xl transition-all duration-300"
        >
          Back to Account
        </Button>
      </main>
      ...
      <nav className="fixed bottom-0 left-0 right-0 bg-white shadow-[0_-2px_10px_rgba(0,0,0,0.05)] z-50 py-4 border-t border-gray-100">
        <div className="max-w-2xl mx-auto flex justify-around">
          <Link
            href="/home"
            className="flex flex-col items-center px-8 py-2 rounded-lg transition-all text-[#6C757D] hover:text-[#FF9933] hover:bg-[#FF9933]/5"
          >
          ...
          <Link
            href="/my-account"
            className="flex flex-col items-center px-8 py-2 rounded-lg transition-all text-[#FF9933] bg-[rgba(0,56,168,0.05)]"
          >
