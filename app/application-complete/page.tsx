      ...
      <div className="min-h-screen bg-gradient-to-b from-[#f5f7fa] to-[#e9ecef] flex items-center justify-center px-4">
        <Card className="w-full max-w-md border-0 shadow-xl">
          <CardContent className="pt-8 pb-6 text-center">
            ...
            <Button 
              className="w-full bg-gradient-to-r from-[#FF9933] to-[#138808] hover:from-[#e68a2e] hover:to-[#0f6d07] text-white font-semibold py-3 rounded-xl"
    ...
    <div className="min-h-screen bg-gradient-to-b from-[#f5f7fa] to-[#e9ecef]">
      ...
      <main className="max-w-4xl mx-auto px-4 py-12">
        ...
        <div className="text-center mb-8">
          <div className="w-20 h-20 bg-gradient-to-r from-[#FF9933] to-[#138808] rounded-full flex items-center justify-center mx-auto mb-4 shadow-lg">
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 border border-gray-100">
          <h2 className="text-lg font-semibold text-[#212529] mb-4">Application Summary</h2>
          <div className="grid grid-cols-2 gap-4">
            <div className="bg-gray-50 p-3 rounded-lg">
              <p className="text-xs text-gray-500 mb-1">Loan Amount</p>
              <p className="text-lg font-bold text-[#FF9933]">{formatIndianCurrency(application.amount_requested)}</p>
            </div>
            <div className="bg-gray-50 p-3 rounded-lg">
              <p className="text-xs text-gray-500 mb-1">Loan Term</p>
              <p className="text-lg font-bold text-[#212529]">{application.loan_term_months} months</p>
            </div>
          </div>
        </div>
        ...
        <div className="bg-white rounded-2xl shadow-lg p-6 mb-8 text-center border border-gray-100">
          ...
          <div className="flex items-center justify-center gap-2">
            <p className="text-xl font-mono font-bold text-[#FF9933]">{application.document_number}</p>
            <button
              onClick={() => copyToClipboard(application.document_number)}
              className="p-2 hover:bg-gray-100 rounded-lg transition-colors"
              title="Copy to clipboard"
            >
              <Copy className={`w-4 h-4 ${copied ? 'text-[#138808]' : 'text-gray-400'}`} />
            </button>
          </div>
          ...
          <div className="space-y-4">
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                <span className="text-xs font-bold text-[#FF9933]">1</span>
              </div>
              <div>
                <p className="font-medium text-[#212529]">Document Verification</p>
                <p className="text-sm text-gray-500">We'll verify your Aadhaar/PAN and KYC documents within 24 hours</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                <span className="text-xs font-bold text-[#FF9933]">2</span>
              </div>
              <div>
                <p className="font-medium text-[#212529]">CIBIL Check & Assessment</p>
                <p className="text-sm text-gray-500">Our team will evaluate your application and credit score</p>
              </div>
            </div>
            <div className="flex items-start gap-3">
              <div className="w-6 h-6 bg-orange-100 rounded-full flex items-center justify-center flex-shrink-0 mt-0.5">
                <span className="text-xs font-bold text-[#FF9933]">3</span>
              </div>
              <div>
        ...
        <div className="bg-gradient-to-r from-orange-50 to-green-50 rounded-2xl p-6 mb-8 border border-[#FF9933]/20">
          <h2 className="text-lg font-semibold text-[#212529] mb-3">For NRI Applicants</h2>
          <ul className="space-y-2 text-sm text-gray-600">
            <li className="flex items-start gap-2">
              <CheckCircle className="w-4 h-4 text-[#138808] mt-0.5 flex-shrink-0" />
        ...
        <div className="flex flex-col sm:flex-row gap-4 justify-center items-center flex-wrap">
          <Link href="/home" className="w-full sm:w-auto sm:flex-1 max-w-xs">
            <Button 
              className="w-full bg-gradient-to-r from-[#FF9933] to-[#138808] hover:from-[#e68a2e] hover:to-[#0f6d07] text-white font-semibold py-3 rounded-xl shadow-md hover:shadow-lg transition-all"
            >
          ...
          <Link href="/my-account/support" className="w-full sm:w-auto sm:flex-1 max-w-xs">
            <Button 
              variant="outline" 
              className="w-full border-2 border-[#FF9933] text-[#FF9933] hover:bg-orange-50 font-semibold py-3 rounded-xl bg-transparent"
            >
