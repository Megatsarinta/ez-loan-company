    ...
    <div className="w-full max-w-5xl mx-auto bg-white p-6" style={{ fontSize: '12px' }}>
      ...
      <div className="flex justify-center mb-5 pb-4 border-b-2 border-[#FF9933]/30">
        <div className="flex items-center gap-4">
          ...
          <div className="text-left">
            ...
            <p className="text-[10px] text-gray-600 mt-0.5">Repayment Period: 2026-02-06 to 2029-02-06</p>
          </div>
        </div>
      </div>
      ...
      <div className="grid grid-cols-2 gap-4 mb-5">
        ...
        <div
          ...
          style={{ borderColor: saffron, backgroundColor: '#fffbf7' }}
        >
          <div className="px-3 py-2 text-white text-[10px] font-bold uppercase tracking-wide" style={{ backgroundColor: saffron }}>
        ...
        >
          <div className="px-3 py-2 text-white text-[10px] font-bold uppercase tracking-wide" style={{ backgroundColor: green }}>
            Loan Details
          </div>
          <div className="p-3 space-y-1.5">
            <div>
        ...
        <table className="w-full text-xs border border-gray-200 rounded-lg overflow-hidden">
          ...
          <tbody>
            {mockSchedule.map((row, index) => (
              ...
              >
                <td className="px-3 py-2.5 font-semibold text-gray-700" style={{ color: navy }}>{row.month}</td>
                <td className="px-3 py-2.5 text-gray-700">{row.dueDate}</td>
                ...
                <td className="px-3 py-2.5 text-right font-mono text-gray-700">₹{row.balance}</td>
              </tr>
            ))}
      ...
      <div className="pt-2 flex justify-between items-center text-[8px] rounded-b-lg" style={{ borderTop: `2px solid ${green}40` }}>
        <div className="text-gray-600">Generated on: {new Date().toLocaleDateString('en-IN', { year: 'numeric', month: 'long', day: 'numeric' })}</div>
